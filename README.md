# Purpose
PortAudio has supported WASAPI loopback but the latest stable release [(v19.0.7)](https://github.com/PortAudio/portaudio/releases/tag/v19.7.0) hasn't included it. So I forked this repo and build on my own.
